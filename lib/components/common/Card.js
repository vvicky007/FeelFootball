    ...
    return (
        <div className="col-sm-6 mt-3">
            ...
            <div className = "card-header">
                ...
                <p>{status =="STATUS_FIRST_HALF"||status=="STATUS_SECOND_HALF"?match.status.displayClock:""}</p>
                <p>{status =="STATUS_HALFTIME"?match.status.displayClock + " (HT)" :""}</p>
                ...
                <div className="card-body">
                    ...
                    <div className = "col-5">
                       ...
                       <p className = "card-text mt-2">{status=="STATUS_FULL_TIME"||status=="STATUS_FIRST_HALF"||status=="STATUS_SECOND_HALF"||status=="STATUS_HALFTIME"?match.competitions[0].competitors[0].score:""}</p>
                       </div>
                    ...
                    <div className = "col-5">
                        ...
                        <p className = "card-text mt-2">{status=="STATUS_FULL_TIME"||status=="STATUS_FIRST_HALF"||status=="STATUS_SECOND_HALF"||status=="STATUS_HALFTIME"?match.competitions[0].competitors[1].score:""}</p>
                        </div>

...
function Stats(props) {
    ...
    useEffect(()=>{
        ...
        getStats(`https://site.api.espn.com/apis/site/v2/sports/soccer/${leagues[leaguename].id}/statistics`)
        ...
        <table className="table mt-0 container" style = {styles.table}>
                ...
                { top_scorers ? top_scorers.map((scorer) => {
                    ...
                    <tr key={scorer.athlete.id}>
                        ...
                        <td>
                        <Button variant="primary" href = {scorer.athlete.links[0].href}>{scorer.athlete.displayName}</Button>
                        </td>
